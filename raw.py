class Indices(NamespacedClient):
    ...
    def exists_alias(self, name, index=None, params=None):
        ...
        :arg ignore_indices: When performed on multiple indices, allows to ignore `missing` ones, default u'none'
        """
        status, data = self.transport.perform_request('HEAD', _make_path(index, '_alias', name), params=params)
        return data
    ...
    @query_params('timeout')
    def put_aliases(self, body, params=None):
        """
        APIs in elasticsearch accept an index name when working against a specific index, and several indices when applicable.
        http://www.elasticsearch.org/guide/reference/api/admin-indices-aliases/

        :arg body: The operations definition and other configuration
        :arg timeout: Explicit operation timeout
        """
    ...
    @query_params('timeout')
    def update_aliases(self, body=None, params=None):
        """
        APIs in elasticsearch accept an index name when working against a specific index, and several indices when applicable.
        http://www.elasticsearch.org/guide/reference/api/admin-indices-aliases/
    ...
    def exists(self, index, params=None):
        ...
        """
        status, data = self.transport.perform_request('HEAD', _make_path(index), params=params)
        return data
    ...
    @query_params('explain', 'ignore_indices', 'operation_threading', 'source')
    ...
    def exists_type(self, index, doc_type, params=None):
        ...
        :arg ignore_indices: When performed on multiple indices, allows to ignore `missing` ones, default u'none'
        """
        status, data = self.transport.perform_request('HEAD', _make_path(index, doc_type), params=params)
        return data
...
class Cluster(NamespacedClient):
    ...
    @query_params('doc_type', 'interval', 'snapshots', 'threads')
    def node_hot_threads(self, node_id=None, params=None):
        """
        ...
        :arg doc_type: The type to sample (default: cpu)
        ...
        :arg threads: Specify the number of threads to provide information for (default: 3)
        """
        status, data = self.transport.perform_request('GET', _make_path('_cluster', 'nodes', node_id, 'hotthreads'), params=params)
        return data
    ...
    def node_stats(self, node_id=None, metric=None, fields=None, params=None):
        ...
        :arg transport: Return information about transport
        """
        status, data = self.transport.perform_request('GET', _make_path('_nodes', node_id, 'stats', 'indices', metric, fields), params=params)
        return data

class Elasticsearch(object):
    @query_params('consistency', 'doc_type', 'refresh', 'replication')
    def bulk(self, index=None, doc_type=None, body=None, params=None):
        """
    ...
    def create(self, index, doc_type, body, id=None, params=None):
        ...
        """
        status, data = self.transport.perform_request('POST', _make_path(index, doc_type, id, '_create'), params=params, body=body)
        return data
    ...
    def exists(self, index, doc_type, id, params=None):
        ...
        :arg routing: Specific routing value
        """
        status, data = self.transport.perform_request('HEAD', _make_path(index, doc_type, id), params=params)
        return data
    ...
    def index(self, index, doc_type, body, id=None, params=None):
        ...
        :arg version_type: Specific version type
        """
        status, data = self.transport.perform_request('POST', _make_path(index, doc_type, id), params=params, body=body)
        return data
    ...
    def msearch(self, index=None, doc_type=None, body=None, params=None):
        """
    ...
    def percolate(self, index, doc_type, body=None, params=None):
        """
    ...
    def scroll(self, scroll_id=None, body=None, params=None):
        ...
        """
        status, data = self.transport.perform_request('GET', _make_path('_search', 'scroll', scroll_id), params=params, body=body)
        return data
